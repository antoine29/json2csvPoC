...
const geoCodeXyzClient = require('./geocodexyz-client');
const objectFieldsFilter = require('./objectFieldsFilter');
...
module.exports = async function coordsArrayToDirectionsArray(coords) {
    ...
    for (let index=0; index<5; index++) {
        ...
        // let response = await geoCodeXyzClient(lati, long);
        let response = await nodeGeocoderClient(lati, long);
